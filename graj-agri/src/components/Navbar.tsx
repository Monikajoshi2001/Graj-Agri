    ...
    <div className="w-full h-10 bg-[#6d9732]"></div>
      ...
      <nav className="flex justify-between items-center p-4 md:px-10 relative">
        ...
        <div className="flex items-center gap-3">
          <button className="bg-yellow-500 text-white px-4 py-2 rounded-md hover:bg-yellow-600 transition-colors hidden sm:block">
            Queries?
          </button>
          ...
          >
              <Menu className="size-8 text-gray-500" />
          </button>
        </div>
      </nav>
      ...
      `}>
        <div className="p-6 space-y-6">
          ...
          <button className="w-full bg-yellow-500 text-white px-4 py-3 rounded-md hover:bg-yellow-600 transition-colors">
            Queries?
          </button>
        </div>
      </div>
